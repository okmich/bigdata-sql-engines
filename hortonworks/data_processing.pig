raw_data = LOAD '/user/maria_dev/raw/flight_performance/flights' USING PigStorage(',') AS 
...
STORE rel_data INTO '/user/maria_dev/processed/flight_performance/flights' Using PigStorage(',');