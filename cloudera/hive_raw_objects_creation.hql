...
location '/user/cloudera/raw/flight_performance/airports';
...
stored as textfile
location '/user/cloudera/raw/flight_performance/carriers';
...
stored as textfile
location '/user/cloudera/raw/flight_performance/planes';
...
location '/user/cloudera/raw/flight_performance/flights';
